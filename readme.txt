=== Quick DynDNS ===
Contributors: JarrenLong
Tags: dns, dynamic dns, ddns, lookup ip address, ip lookup, ip address, show ip address, quick
...
1. Display shortcode
2. Dashboard
3. Shortcode in a widget

== Changelog ==
= 1.1.0 =
Released: August xth, 2016
